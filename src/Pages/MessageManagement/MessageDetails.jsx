        ...
        >
          ...
          >
            ...
            <Box sx={{ display: "flex", gap: 2 }}>
              <CommonButton text="Mark Safe" size="medium" iconName={'readAll'} color="#60A5FA" />
              <CommonButton text="Warn Sender" size="medium" icon={warnIcon} color="#F97316" />
              <CommonButton text="Suspend Sender" size="medium" iconName={'suspend'} color="#9CA3AF" />
              <CommonButton text="Delete Message" size="medium" iconName={'delete'} color="#F87171" />
            </Box>
          </Box>
          ...
          >
            ...
            >
              ...
              >
                <SwapHorizIcon sx={{ fontSize: '40px' }} />
              </Box>

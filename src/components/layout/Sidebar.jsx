  ...
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M17.9 17.3C20.6 17.3 22.7 15.1 22.7 12.4C22.7 9.7 20.5 7.6 17.8 7.6C15.1 7.6 13 9.8 13 12.4C13 15.1 15.2 17.3 17.9 17.3Z" fill="currentColor" />
        <path d="M32.7 16.7C30.8 15 28.3 14.1 25.7 14.2H24.9C24.7 15 24.4 15.7 24 16.3C24.6 16.2 25.1 16.2 25.7 16.2C27.6 16.1 29.5 16.7 31 17.8V25H33V17L32.7 16.7Z" fill="currentColor" />
        <path d="M23.4 7.8C23.9 6.6 25.3 6 26.6 6.5C27.8 7 28.4 8.4 27.9 9.7C27.5 10.6 26.6 11.2 25.7 11.2C25.5 11.2 25.2 11.2 25 11.1C25.1 11.6 25.1 12.1 25.1 12.5V13.1C25.3 13.1 25.5 13.2 25.7 13.2C28.2 13.2 30.2 11.2 30.2 8.8C30.2 6.3 28.2 4.3 25.8 4.3C24.2 4.3 22.8 5.1 22 6.5C22.5 6.8 23 7.2 23.4 7.8Z" fill="currentColor" />
        <path d="M12 16.4C11.6 15.8 11.3 15.1 11.1 14.3H10.3C7.7 14.2 5.2 15.1 3.3 16.7L3 17V25H5V17.8C6.6 16.7 8.4 16.1 10.3 16.2C10.9 16.2 11.5 16.3 12 16.4Z" fill="currentColor" />
        <path d="M10.3 13.1C10.5 13.1 10.7 13.1 10.9 13V12.4C10.9 11.9 10.9 11.4 11 11C10.8 11.1 10.5 11.1 10.3 11.1C9 11.1 7.9 10 7.9 8.7C7.9 7.4 9 6.3 10.3 6.3C11.3 6.3 12.2 6.9 12.6 7.8C13 7.3 13.6 6.8 14.1 6.4C12.8 4.3 10.1 3.6 8 4.9C5.9 6.2 5.2 8.9 6.5 11C7.3 12.3 8.7 13.1 10.3 13.1Z" fill="currentColor" />
        <path d="M26.1 22.7L25.9 22.4C23.9 20.2 21.1 18.9 18.1 19C15.1 18.9 12.2 20.2 10.2 22.4L10 22.7V30.3C10 31.2 10.7 32 11.7 32H24.5C25.4 32 26.2 31.2 26.2 30.3V22.7H26.1Z" fill="currentColor" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M11.595 24.75H13.095V18H11.595V24.75ZM22.905 24.75H24.405V10.5H22.905V24.75ZM17.25 24.75H18.75V21H17.25V24.75ZM17.25 18H18.75V15H17.25V18ZM8.424 30C7.733 30 7.1565 29.769 6.6945 29.307C6.2325 28.845 6.001 28.268 6 27.576V8.424C6 7.733 6.2315 7.1565 6.6945 6.6945C7.1575 6.2325 7.734 6.001 8.424 6H27.5775C28.2675 6 28.844 6.2315 29.307 6.6945C29.77 7.1575 30.001 7.734 30 8.424V27.5775C30 28.2675 29.769 28.844 29.307 29.307C28.845 29.77 28.268 30.001 27.576 30H8.424ZM8.424 28.5H27.5775C27.8075 28.5 28.019 28.404 28.212 28.212C28.405 28.02 28.501 27.808 28.5 27.576V8.424C28.5 8.193 28.404 7.981 28.212 7.788C28.02 7.595 27.808 7.499 27.576 7.5H8.424C8.193 7.5 7.981 7.596 7.788 7.788C7.595 7.98 7.499 8.192 7.5 8.424V27.5775C7.5 27.8075 7.596 28.019 7.788 28.212C7.98 28.405 8.1915 28.501 8.4225 28.5" fill="currentColor" />
      </svg>
    ),
  },
  {
